  ...
  return (
    ...
    >
      ...
      <div className="container relative z-20 text-center text-white max-w-2xl">
        <Title typeTitle={'h1'} className={'text-4xl md:text-6xl'}><span className={'text-4xl md:text-6xl text-green-600 font-black text-shadow-xs text-shadow-black bg-black px-1 inline-block mb-2'}>BUNKER</span><br/> BARBERSHOP</Title>
